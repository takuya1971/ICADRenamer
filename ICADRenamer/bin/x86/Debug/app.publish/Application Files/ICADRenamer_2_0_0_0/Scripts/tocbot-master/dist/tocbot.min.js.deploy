! function (e) {
    ...
    (function (o) {
        ...
        ! function (n, o) {
            ...
            if ("undefined" != typeof window || d) {
                var f, m = Object.prototype.hasOwnProperty;
                return c.destroy = function () {
                    ...
                    if (d && (s = t(i, e || {}), this.options = s, this.state = {}, s.scrollSmooth && (s.duration = s.scrollSmoothDuration, s.offset = s.scrollSmoothOffset, c.scrollSmooth = n(5).initSmoothScrolling(s)), l = a(s), r = u(s), this._buildHtml = l, this._parseContent = r, c.destroy(), null !== (f = r.selectHeadings(s.contentSelector, s.headingSelector)))) {
                        var m = r.nestHeadingsArray(f),
                            h = m.nest;
                        s.skipRendering || l.render(s.tocSelector, h), this._scrollListener = o(function (e) {
                            l.updateToc(f);
                            var t = e && e.target && e.target.scrollingElement && 0 === e.target.scrollingElement.scrollTop;
                            (e && (0 === e.eventPhase || null === e.currentTarget) || t) && (l.updateToc(f), s.scrollEndCallback && s.scrollEndCallback(e))
                        ...
                        return this._clickListener = o(function (e) {
                            s.scrollSmooth && l.disableTocAnimation(e), l.updateToc(f), p && clearTimeout(p), p = setTimeout(function () {
    ...
    e.exports = function (e) {
        ...
        function l(n, l) {
            for (var r = o(n), i = r.headingLevel, s = l, c = t(s), a = c ? c.headingLevel : 0, u = i - a; u > 0;) c = t(s), c && void 0 !== c.children && (s = c.children), u--;
            return i >= e.collapseDepth && (r.isCollapsed = !0), s.push(r), s
        }
